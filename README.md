...
> **Portfolio Note**
>
> The projects in this portfolio are designed to **demonstrate hands-on experience with the tools and workflows used daily in enterprise IT support and cloud support environments**.
>
> Each project focuses on practical tasks such as user lifecycle management, identity troubleshooting, IT service management, and Microsoft Azure administration — the same work performed by IT Support Specialists, M365 Administrators, and Cloud Support Engineers in enterprise organizations.
>
> The goal is to show not just that I studied these tools, but that I can **deploy, configure, troubleshoot, and document them at an enterprise level**.
...
| [**IT Service Management & Ticketing Lab**](https://github.com/camerongoodwin03/osticket-itsm-lab) | Screenshots Included | Deployed osTicket on an Azure VM and documented a full enterprise incident lifecycle — ticket creation, triage, escalation, resolution, and closure — aligned to ITIL 4 service management principles. Simulated real helpdesk workflows including SLA tracking, priority classification, and knowledge base documentation. | osTicket · Azure VM · ITIL 4 | ![Complete](https://img.shields.io/badge/Complete-2ea44f?style=flat-square) |
...
| **IT Support** | ITIL 4 · osTicket · Incident Management · Root Cause Analysis · Technical Troubleshooting |

---

## Education

**B.S. Cloud and Network Engineering** — Western Governors University *(In Progress)*

---

[Connect on LinkedIn](https://www.linkedin.com/in/camerongoodwin03)
